...
<article id="content">
	...
	<ol>
		...
		<li><a href="#3">Socket examples</a></li>
		<li><a href="#4">BGA examples</a></li>
		<li><a href="#5">Controlled impedance to lead of package / die pad</a></li>
	...
	<section id="1">
		...
		<div class="d-flex justify-content-center align-items-center">
			<img src="images/RFSockets/S11.jpg">
		</div>
		...
		<table border="0" cellpadding="5" cellspacing="0" align="center" valign="top">
			<tbody><tr valign="top">
				<td>
					<img src="images/RFSockets/DUT-1.jpg">
					<br>
				...
				<td>
					<img src="images/RFSockets/DUT-2.jpg">
					<br>
			...
			<tr>
				...
				<td>
					<img src="images/RFSockets/BareDieTestSocket.jpg">
				</td>
			</tr>
		</tbody></table>
	...
	<section id="2">
		...
		<div class="d-flex justify-content-center align-items-center">
		<img src="images/RFSockets/PI-ContactLife.jpg">
	</div>
		...
		<div class="d-flex justify-content-center align-items-center">
		<img src="images/RFSockets/EyeDiagram10Gb-PAM4.jpg">
	</div>
		<h3>Particle Interconnect contact resistance vs. contact force</h3>
		<img src="images/RFSockets/PI-ContactResistanceVSContactForce-1mmPitchBGAInterposer.jpg" alt="" title="" style="float:right; margin:0px 0px 0px 5px;">
		...
		<table border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
			<tbody><tr>
				<td><img src="images/RFSockets/PI-ArrayTopSide.jpg"></td>
				<td><img src="images/RFSockets/PI-BottomSide.jpg"></td>
			</tr>
			<tr>
	...
	<section id="3">
		...
		<table border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
			<tbody><tr>
				<td><img src="images/RFSockets/PI-Ceramic14LeadRFSOICTestSocket.jpg"></td>
				<td><img src="images/RFSockets/PI-Ceramic28LeadRFSOICTestSocket.jpg"></td>
			</tr>
			<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
			<tbody><tr>
				<td>
					<img src="images/RFSockets/RF-SOIC.jpg">
					<p>0.02", 0.025", 0.05" pitch,<br>RF SOIC and QFP FR-4 test fixture<br>with active components and controlled Z<sub>0</sub></p>
				</td>
				<td>
					<img src="images/RFSockets/RFIC.jpg"><br>
					20 GHz 48 leads QFP RFIC
				</td>
			</tr>
		</tbody></table>
		<h3>Louver contact</h3>
		<p><img src="images/RFSockets/PI-LouverContact.jpg"></p>
		...
		<table border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
			<tbody><tr>
				<td>
					<img src="images/RFSockets/PI-PLCC-20-84Lead50MilSocket.jpg">
				</td>
				<td>
					<img src="images/RFSockets/PI-PLCC-NestedSocket.jpg">
				</td>
			</tr>
		</tbody></table>
	</section>
	<section id="4">
		...
		<table border="0" cellpadding="5" cellspacing="0" align="center" valign="top">
			<tbody><tr>
				<td><img src="images/RFSockets/PI-Sandia-MiniBGA30milPitchDieCloseup.jpg"></td>
				<td><img src="images/RFSockets/PI-BGA30milPitchSocket.jpg"></td>
			</tr>
			<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
			<tbody><tr>
				<td><img src="images/RFSockets/PI-Sandia-InterposerSchematic1993.jpg"></td>
				<td><img src="images/RFSockets/PI-Sandia-30milPitchInterposer.jpg"></td>
			</tr>
			<tr>
		...
		<p><img src="images/RFSockets/PI-BGASeasawSocket.jpg"></p>
	</section>
	<section id="5">
		...
		<table border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
			<tbody><tr>
				<td><img src="images/RFSockets/PLCC-Schematic.jpg"></td>
				<td><img src="images/RFSockets/PI-PLCC-Lead30000Insertions.jpg"></td>
			</tr>
			<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
			<tbody><tr>
				<td><img src="images/RFSockets/PLCC-PCBLayout.jpg"></td>
				<td><img src="images/RFSockets/PLCC-MechanicalHolddown.jpg"></td>
			</tr>
			<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
			<tbody><tr>
				<td><img src="images/RFSockets/PLCC-CircuitLayout.jpg"></td>
				<td><img src="images/RFSockets/PLCC-CircuitLayout2.jpg"></td>
			</tr>
		</tbody></table>
		...
		<table class="smaller" border="0" cellpadding="0" cellspacing="0" align="center" valign="top">
			<tbody><tr>
				<td><img src="images/RFSockets/PLCC-TDR-PI-Contribution1.jpg"></td>
				<td><img src="images/RFSockets/PLCC-TDR-PI-Contribution2.jpg"></td>
			</tr>
			<tr>
				<td>
